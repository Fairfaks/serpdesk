...
function redact(value) {
  ...
  return text
    ...
    .replace(/("(?:key|user|token|access_token|refresh_token|client_id|client_secret|password|api_key|authorization|xmlriver_key|xmlriver_user|yavm_token|metrika_token|gsc_client_id|gsc_client_secret|gsc_refresh_token|private_key)"\s*:\s*")[^"]*(")/gi, '$1[скрыто]$2')
